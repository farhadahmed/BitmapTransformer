...
function transformAddfive(base, newBuf) {
  for (var i = 1078; i < base.length-1; i++) {
    newBuf[i] = 5 + base.readUInt8(i);
  };
};

exports.bufferTransform = function() {
  ...
  transformAddfive(buf2, secondBuf);
